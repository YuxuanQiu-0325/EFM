...
#data = tag_based_Z(data) #############################
def generate_graph(data):
    cutoff = 12  # 12
    max_neighbors = 20  # 20
    use_pbc = True
    otf_graph =  True
    enforce_max_neighbors_strictly = True  # 根据需要指定
    ...
    if use_pbc:
        if otf_graph:
            edge_index, cell_offsets, neighbors = radius_graph_pbc(  # 生成周期性边界图
                data,
                cutoff,
                max_neighbors,
                enforce_max_neighbors_strictly,
...
def radius_graph_pbc(
    ...
    # 将 data.cell 的形状从 (16, 1, 3, 3) 调整为 (16, 3, 3)
    data.cell = data.cell.squeeze(1)
    print("data.cell shape:", data.cell.shape)
    ...
    pbc_offsets = torch.bmm(data_cell, unit_cell_batch)  #(16,3,3)(32,3,45)源代码是(12,3,3)(12,3,75)
